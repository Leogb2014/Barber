...
function Config() {
  return (
    <div className='flex flex-col items-start  gap-4 container mx-auto  w-full h-screen  bg-[#1c1c22]'>
        <div className='border-b-2 p-4 w-full'>
          
        <div  className=' justify-between flex items-center gap-2 text-white'>
          Ativar notificações 
        ...
        <button  className='flex flex-col  items-start  text-white'>
        ...
        <div className='border-b-2 w-full  text-white'>
